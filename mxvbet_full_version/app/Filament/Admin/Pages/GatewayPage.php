...
class GatewayPage extends Page
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Gateway iBpay')
                    ->description(new HtmlString('Para gerar suas credenciais, contate -  <a href="https://t.me/isupportbets" target="_blank" style="color: blue;">Clique aqui!</a>'))
                    ->schema([
                        TextInput::make('url_ibs')
                            ->label('URL do gateway')
                            ->placeholder('Digite o URL do gateway.')
                            ->default('https://ibpay.co')
                            ->maxLength(191),
                        TextInput::make('token_ibs')
                            ->label('Token')
                            ->placeholder('Digite o Client ID')
                            ->maxLength(191),
                        TextInput::make('secret_ibs')
                            ->label('Secret')
