...
trait VeniXTrait
{
     ...
     * @var string
     */
    public static $apiUri = 'https://easyconnect.games/api/v1/';
        ...
        if (!empty($user) && !empty($wallet)) {
            ...
            if ($request->type == 'win') {
                ...
                if (!empty($checkTransaction)) {
                    ...
                    $game = Game::where('game_id', $request->game)->first();

                    self::CheckMissionExist($request->user_id, $game);
