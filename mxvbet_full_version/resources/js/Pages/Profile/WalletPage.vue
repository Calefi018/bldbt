    ...
    <BaseLayout>
        <div class="flex items-center justify-center  min-h-screen sm:max-w-[690px] lg:max-w-[710px] mx-auto p-4">
            <div v-if="setting != null" class="w-full">
                <div v-if="!isLoadingWallet" class="flex flex-col w-full bg-gray-200 hover:bg-gray-300/20 dark:bg-gray-800/50 p-4 rounded hover:dark:bg-gray-900" style="background-color: var(--navtop-color-dark);">
                    <!-- Seu conteúdo aqui -->
                            ...
                            <button v-for="(wallet, index) in mywallets" :key="index" @click.prevent="setWallet(wallet.id)" type="button" class="relative inline-flex justify-between items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-200 rounded-t-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white">
                                <div class="flex items-center">
                                    ...
                                    <div class="flex flex-col items-start">
                                        <p>{{ wallet.symbol }} {{ wallet.balance_withdrawal }}</p>
                                        <p class="text-[12px] dark:text-gray-500">{{ wallet.symbol }} {{ wallet.balance }}</p>
                                    </div>
                                </div>
                    ...
                    <div class="mt-5 border-2 border-gray-600 col-span-2"></div>
            
                    <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 w-full p-4 bg-gray-800 rounded-md">
                        
                        <!-- Saldo Total -->
                        <div class="flex items-center bg-gray-900 p-4 rounded-md">
                            <div class="flex justify-center items-center bg-yellow-400 rounded-full p-3">
                                <i class="fa-light fa-wallet text-3xl text-gray-800"></i>
                            </div>
                            <div class="leading-tight ml-4">
                                <span class="text-gray-300">Saldo Total</span>
                        ...
                        <div class="flex items-center bg-gray-900 p-4 rounded-md">
                            ...
                            <div class="leading-tight ml-4">
                                <span class="text-gray-300">{{ $t('Withdrawal Balance') }}</span>
                        ...
                        <div class="flex items-center bg-gray-900 p-4 rounded-md">
                            ...
                            <div class="leading-tight ml-4">
                                <span class="text-gray-300">Saldo Bloqueado</span>
                        ...
                        <div class="flex items-center bg-gray-900 p-4 rounded-md">
                            ...
                            <div class="leading-tight ml-4">
                                <span class="text-gray-300">Saldo de Bônus</span>
