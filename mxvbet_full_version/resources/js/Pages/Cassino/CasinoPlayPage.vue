<template>
    <GameLayout>
        ...
        <div v-if="!isLoading && game" :class="{ 'w-full': modeMovie, 'lg:w-2/3': !modeMovie }" class="mx-auto px-2 lg:px-4 py-2 lg:py-6 relative">
            <div class="game-screen" id="game-screen">
                <fullscreen v-model="fullscreen" :page-only="pageOnly">
                    ...
                    <iframe v-if="game.distribution === 'venix'" :src="gameUrl" class="game-full fullscreen-wrapper"></iframe>
        ...
        <div class="absolute top-5 left-4">
            <a href="/" class="bg-red-500 text-white px-2 py-1 rounded shadow hover:bg-red-600 transition text-lg">
                X
            </a>
        </div>
    </GameLayout>
