<template>
    <AuthLayout>
        ...
        <div v-if="!isLoading" class="">
            <div class="">
                <div class="min-h-[calc(100vh-565px)] text-center flex flex-col items-center justify-center min-h-screen">
                    <div class="register-afiliado w-full md:mt-0 sm:max-w-md xl:p-0 dark:border-gray-700">
                        <div class="register-afiliado p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div class="mt-4 px-4">
                                <form @submit.prevent="registerSubmit" method="post" action="" class="padding-register">
                                    ...
                                    <div class="tirar-div"
                                        style="width: 100%;height: 1px;background-color: var(--carousel-banners-dark);;margin-bottom: 20px;">
                                    </div>

                                    <div
                                        style="display: flex;justify-content: center;margin: 0 auto;margin-bottom: 20px">
                                        <a v-if="setting" class="flex md:ml-2 ml:1 md:mr-24 items-center pb-4"
                                            ...
                                            <img :src="`/storage/` + setting.software_logo_white" alt=""
                                                class="md:max-h-[35px] max-h-[30px] hidden dark:block" />
                                        </a>
                                    </div>

                                    <div class="relative mb-3 sho">
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">

                                        </div>
                                        <input
                                            style="padding: 17px 0px;padding-left: 20px;background-color: var(--input-primary);"
                                            type="text" name="name" v-model="registerForm.name" class="input-group"
                                            :placeholder="$t('Nome')" required>
                                    </div>
                                    ...
                                    <div class="relative mb-3">
                                        ...
                                        <input
                                            style="padding: 17px 0px;padding-left: 20px;background-color: var(--input-primary);"
                                            type="email" name="email" v-model="registerForm.email" class="input-group"
                                    ...
                                    <div class="relative mb-3">
                                        ...
                                        <input
                                            style="padding: 17px 0px;padding-left: 20px;background-color: var(--input-primary);"
                                            type="cpf" name="cpf" v-model="registerForm.cpf" class="input-group"
                                            :placeholder="$t('CPF')" required>
                                    </div>
                                    ...
                                    <div class="relative mb-3">
                                        ...
                                        <input
                                            style="padding: 17px 0px;padding-left: 20px;background-color: var(--input-primary);"
                                            :type="typeInputPassword" name="password" v-model="registerForm.password"
                                            class="input-group pr-[40px]" :placeholder="$t('Senha')" required>
                                        <button type="button" @click.prevent="togglePassword"
                                            class="absolute inset-y-0 right-0 flex items-center pr-3.5 ">
                                            <svg v-if="typeInputPassword === 'text'"
                                                class="fa-sharp fa-regular fa-eye-slash" data-v-9b35dc4c="" height="1em"
                                                viewBox="0 0 576 512" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <svg v-if="typeInputPassword === 'password'" class="fa-regular fa-eye"
                                                data-v-9b35dc4c="" height="1em" viewBox="0 0 640 512" width="1em"
                                    ...
                                    <p style="text-align: center;font-size: 10px;color: white;font-weight: lighter;margin-bottom: -14px"
                                        class="text-sm text-gray-500 dark:text-gray-300 mb-6 pt-4"><a
                                            @click="$router.push('/terms/service')" href="">Ao se registrar <strong
                                                style="color:var(--ci-primary-color);font-weight: lighter;">você
                                                concorda com nossos termos e condições</strong></a></p>

                                    <div class="mt-5 w-full flex flex-col items-center">
                                        <button
                                            style="color: var(--title-color);font-size: 17px;font-weight: 600;padding: 12px;width: 100%;margin: 0 auto;color: var(--title-color);"
                                            type="submit" class="ui-button-blue w-full mb-3">
