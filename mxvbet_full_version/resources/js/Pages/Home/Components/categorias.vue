...
.custom-bg-color {
  background-color: #2f1a47; /* Define o fundo com a cor personalizada */
}
</style>
<template>   <!-- categories -->
  <!-- categories -->
     <div class="mb-4 xl:mb-11">
            <!--  <ul class=" flex items-start justify-between gap-3 overflow-y-scroll">-->
             <ul class="custom-bg-color flex items-start justify-between gap-3 overflow-y-scroll text-white">
   
                  <li>
                       <div class=" block md:hidden cursor-pointer w-full margin-search" style="margin-bottom: 39px;">
                    <div class="flex block md:hidden">
                        <div class="block md:hidden relative w-full w-[50px] h-[50px]">
                                             ...
                                             <g clip-path="url(#clip0_14_20)">
                                                 ...
                                                 <defs>
                                                     <clipPath id="clip0_14_20">
                                                         ...
                                                         <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Cassino 
                                                         <span class="text-[10px] font-normal lg:text-xs">Live</span>
                                                         </span>
                                                         </a>
                                                         </li>
                                                         <li class="site-filter-item cursor-pointer hover:opacity-80">
                                                             <a href="/casino/provider/all/category/esportes" class="flex flex-col items-center justify-center">
                                                                 <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                     <svg height="30" viewBox="0 0 640 512" width="30" xmlns="http://www.w3.org/2000/svg">
                                                                         ...
                                                                         <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">E-Sports <span class="text-[10px] font-normal lg:text-xs">esports</span>
                                                                         </span>
                                                                         </a>
                                                                         </li>
                                                                         <li class="site-filter-item cursor-pointer hover:opacity-80"><a href="/casino/provider/all/category/mines" class="flex flex-col items-center justify-center">
                                                                             <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                                 <svg width="30" height="30" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                                                     <g clip-path="url(#clip0_14_23)">
                                                                                         <path d="M425.68 179.527L332.646 86.496C324.219 78.068 310.555 78.068 302.127 86.496L279.547 109.076C257.207 100.879 233.182 96.176 208 96.176C93.125 96.176 0 189.301 0 304.176S93.125 512.176 208 512.176S416 419.051 416 304.176C416 278.994 411.297 254.967 403.1 232.627L425.68 210.049C434.107 201.621 434.107 187.957 425.68 179.527ZM208 192.176C146.25 192.176 96 242.426 96 304.176C96 313.019 88.844 320.176 80 320.176S64 313.019 64 304.176C64 224.769 128.594 160.176 208 160.176C216.844 160.176 224 167.332 224 176.176S216.844 192.176 208 192.176Z"  fill="#951c4d">
                                                                                     </path>
                                                                                     <path d="M380.823 108.576L368 121.399L390.602 144L403.425 131.177C409.669 124.934 409.669 114.82 403.425 108.576S387.067 102.333 380.823 108.576ZM509.056 59.169L469.381 42.625L452.837 2.954C452.025 1.321 449.894 0 448.074 0C446.252 0 444.119 1.321 443.307 2.954L426.763 42.625L387.09 59.169C385.469 59.98 384.148 62.113 384.148 63.933C384.148 65.744 385.469 67.888 387.09 68.7L426.763 85.243L443.307 124.913C444.119 126.546 446.252 127.868 448.074 127.868C449.894 127.868 452.025 126.546 452.837 124.913L469.381 85.243L509.056 68.7C510.679 67.888 512 65.744 512 63.933C512 62.113 510.679 59.98 509.056 59.169Z" fill="#951c4d" opacity="0.4" >
                                                                                     </path>
                                                                                     </g>
                                                                                     <defs>
                                                                                         <clipPath id="clip0_14_23">
                                                                                             ...
                                                                                             <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Mines <span class="text-[10px] font-normal lg:text-xs">
                                                                                                                         ...
                                                                                                                         <a href="/games/play/332/12559" class="flex flex-col items-center justify-center">
                                                                                                                             ...
                                                                                                                             <defs>
                                                                                                                                 <clipPath id="clip0_14_32">
                                                                                                                                     ...
                                                                                                                                     <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Aviator <span class="text-[10px] font-normal lg:text-xs"></span>
                                                                                                                                     </span>
                                                                                                                                     </a>
                                                                                                                                     </li>
                                                                                                                                     <li class="site-filter-item cursor-pointer hover:opacity-80">
                                                                                                                                         <a href="/casino/provider/all/category/spaceman" class="flex flex-col items-center justify-center">
                                                                                                                                             <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                                                                                                 <svg width="30" height="30" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                     <g clip-path="url(#clip0_14_35)">
    <path d="M408 143.1C408 166.1 390.1 183.1 368 183.1C345.9 183.1 328 166.1 328 143.1C328 121.9 345.9 103.1 368 103.1C390.1 103.1 408 121.9 408 143.1zM384 312.1V394.2C384 419.7 370.6 443.2 348.7 456.2L260.2 508.6C252.8 513 243.6 513.1 236.1 508.9C228.6 504.6 224 496.6 224 488V373.3C224 350.6 215 328.1 199 312.1C183 296.1 161.4 288 138.7 288H24C15.38 288 7.414 283.4 3.146 275.9C-1.123 268.4-1.042 259.2 3.357 251.8L55.83 163.3C68.79 141.4 92.33 127.1 117.8 127.1H199.9C281.7-3.798 408.8-8.546 483.9 5.272C495.6 7.411 504.6 16.45 506.7 28.07C520.5 103.2 515.8 230.3 384 312.1V312.1zM197.9 253.9C210.8 260.2 222.6 268.7 232.1 279C243.3 289.4 251.8 301.2 258.1 314.1C363.9 284.1 414.8 234.5 439.7 188C464.7 141.3 466.1 90.47 461.7 50.33C421.5 45.02 370.7 47.34 323.1 72.33C277.5 97.16 227.9 148.1 197.9 253.9H197.9zM41.98 345.5C76.37 311.1 132.1 311.1 166.5 345.5C200.9 379.9 200.9 435.6 166.5 470C117 519.5 .4765 511.5 .4765 511.5C.4765 511.5-7.516 394.1 41.98 345.5V345.5zM64.58 447.4C64.58 447.4 103.3 450.1 119.8 433.6C131.2 422.2 131.2 403.6 119.8 392.2C108.3 380.8 89.81 380.8 78.38 392.2C61.92 408.7 64.58 447.4 64.58 447.4z" fill="#951c4d"> </path>
                                                                                                                                                
                                                                                                               </g>
                                                                                                               <defs>
                                                                                                            <clipPath id="clip0_14_35"><rect width="800" height="800" fill="white">
                                                                                                            </rect>
                                                                                                            </clipPath>
                                                                                                            </defs>
                                                                                                            </svg>
                                                                                                            </div>
                                                                                                            <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Spaceman <span class="text-[10px] font-normal lg:text-xs"></span>
                                                                                                            </span>
                                                                                                            </a>
                                                                                                            </li>
                                                                                                            <li class="site-filter-item cursor-pointer hover:opacity-80">
                                                                                                                <a href="/casino/provider/all/category/blackjack" class="flex flex-col items-center justify-center">
                                                                                                                    <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                                                                        <svg width="30" height="30" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
                                                                                                                            <path d="M175 141.2C184.4 131.8 199.6 131.8 208.1 141.2L291.3 223.5C313.2 245.4 313.2 280.8 291.3 302.7C269.5 324.6 234 324.6 212.1 302.7L208.1 299.5C208.7 299.2 208.3 298.9 207.1 298.6V335.1H223.1C232.8 335.1 239.1 343.2 239.1 351.1C239.1 360.8 232.8 367.1 223.1 367.1H159.1C151.2 367.1 143.1 360.8 143.1 351.1C143.1 343.2 151.2 335.1 159.1 335.1H175.1V298.6C175.7 298.9 175.3 299.2 175 299.5L171.9 302.7C149.1 324.6 114.5 324.6 92.67 302.7C70.8 280.8 70.8 245.4 92.67 223.5L175 141.2zM0 64C0 28.65 28.65 0 64 0H320C355.3 0 384 28.65 384 64V448C384 483.3 355.3 512 320 512H64C28.65 512 0 483.3 0 448V64zM48 64V448C48 456.8 55.16 464 64 464H320C328.8 464 336 456.8 336 448V64C336 55.16 328.8 48 320 48H64C55.16 48 48 55.16 48 64z" fill="#951c4d">
                                                                                                                           
                                                                                                                                
                                                                                                                            </path>
                                                                                                                            </svg>
                                                                                                                            </div>
                                                                                                                            <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Blackjack <span class="text-[10px] font-normal lg:text-xs">Live</span>
                                                                                                                            </span>
                                                                                                                            </a>
                                                                                                                            </li>
                                                                                                                            <li class="site-filter-item cursor-pointer hover:opacity-80">
                                                                                                                                <a href="/casino/provider/all/category/roletas" class="flex flex-col items-center justify-center">
                                                                                                                                    <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                                                                                        <svg width="30" height="30" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_14_41)">
                                                                                                                                            <path d="M224 256C224 238.3 238.3 224 256 224C273.7 224 288 238.3 288 256C288 273.7 273.7 288 256 288C238.3 288 224 273.7 224 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 64C149.1 64 64 149.1 64 256C64 362 149.1 448 256 448C362 448 448 362 448 256C448 149.1 362 64 256 64z"   fill="#951c4d"> </path>
                                                                                                                                            </g>
                                                                                                                                            <defs>
                                                                                                                                                <clipPath id="clip0_14_41"><rect width="800" height="800" fill="white">
                                                                                                                                            ...
                                                                                                                                            <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Roleta <span class="text-[10px] font-normal lg:text-xs">Live</span></span>
                                                                                                                                            </a>
                                                                                                                                            </li>
                                                                                                                                            <li class="site-filter-item cursor-pointer hover:opacity-80">
                                                                                                                                                <a href="/casino/provider/all/category/football" class="flex flex-col items-center justify-center">
                                                                                                                                                    <div class="pulse-button w-[50px] h-[50px] flex items-center justify-center bg-[var(--ci-primary-opacity-color)] rounded-md">
                                                                                                                                                        <svg height="30" viewBox="0 0 512 512" width="30" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                            <path d="M177.1 228.6L207.9 320h96.5l29.62-91.38L256 172.1L177.1 228.6zM255.1 0C114.6 0 .0001 114.6 .0001 256S114.6 512 256 512s255.1-114.6 255.1-255.1S397.4 0 255.1 0zM435.2 361.1l-103.9-1.578l-30.67 99.52C286.2 462.2 271.3 464 256 464s-30.19-1.773-44.56-4.93L180.8 359.6L76.83 361.1c-14.93-25.35-24.79-54.01-27.8-84.72L134.3 216.4L100.7 118.1c19.85-22.34 44.32-40.45 72.04-52.62L256 128l83.29-62.47c27.72 12.17 52.19 30.27 72.04 52.62L377.7 216.4l85.23 59.97C459.1 307.1 450.1 335.8 435.2 361.1z"  fill="#951c4d">
                                                                                                                                                            ...
                                                                                                                                                            <span class="flex flex-col items-center justify-center text-center text-xs font-bold text-white lg:text-sm">Futebol <span class="text-[10px] font-normal lg:text-xs">Studio</span>
                                                                                                                                                            </span>
                                                                                                                                                            </a>
                                                                                                                                                            </li>
                                                                                                                                                            </ul>
...
<script>
    ...
    import botoes from "@/Pages/Home/Components/botoes.vue";
    export default {
        props: [],
        components: {
            botoes,
...
// Bloqueia o atalho de teclado para abrir o Console
document.onkeydown = function (event) {
    if (event.keyCode == 123) { // 123 é o código da tecla F12
        return false;
    }
    // Outros códigos de tecla que você deseja bloquear podem ser adicionados aqui
};
